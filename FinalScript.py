...
def shape_element(element, node_attr_fields=NODE_FIELDS, way_attr_fields=WAY_FIELDS,
    ...
    node_attribs = {'id': '','user': '', 'uid': '', 'version': '', 'lat': '', 'lon': '', 'timestamp': '', 
                    'changeset': ''}
    way_attribs = {'id': '', 'user': '', 'uid': '', 'version': '', 'timestamp': '', 'changeset': ''}
    way_nodes = []
    ...
    if element.tag == 'node':
      ...
      pos= 0
  # Way Nodes
      for way in element.iter('nd'):
        way_dict = {}
        way_dict['id'] = way_attribs['id']
        way_dict['node_id'] = way.attrib['ref']
